  ...
  return (
    <rect
      ...
      style={{
        outline: 'none',
        filter: isActive
          ? 'drop-shadow(0 0 7px rgba(255, 95, 207, 0.72))'
          : undefined,
      }}
    />
  );
...
export function GraphAnalytics({
  ...
  const [activeParticipationLabel, setActiveParticipationLabel] =
    ...
    <div className="relative mx-auto max-w-7xl">
      <div className="mb-10 flex flex-col gap-6 sm:mb-14 md:flex-row md:items-end md:justify-between">
        <div className="max-w-2xl">
          ...
          <h2
            id="analytics-title"
            data-text="GRAPH AND ANALYTICS."
            className={`${styles.sponsorHeading} uppercase leading-[.85]`}
          >
            GRAPH AND ANALYTICS.
          </h2>
        </div>

        <p className="max-w-sm border-l border-[#ff5fcf]/60 pl-4 font-mono text-xs leading-relaxed text-white/60">
          Hover or select any signal point to inspect how the Codeutsava
      ...
      >
        ...
        <div className={styles.content}>
          <header className={styles.intro}>
            <h2 id="analytics-title" className={styles.sectionHeading}>
              GRAPH AND ANALYTICS
            </h2>
          ...
          <div className={styles.chartGrid}>
            <article
              ...
              aria-labelledby="teams-chart-title"
            >
              <header className={styles.chartCardHeader}>
                <p id="teams-chart-title" className={styles.metricLabel}>
                  <Users size={19} /> Total number of teams
                </p>
                <span className={styles.metricNote}>2016 — 2024</span>
              </header>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <Tooltip
                      ...
                      content={<ChartTooltip suffix="teams" />}
                    />
            ...
            <article
              className={styles.chartCard}
              aria-labelledby="participation-chart-title"
            >
              <header className={styles.chartCardHeader}>
                <p
                  id="participation-chart-title"
                  className={styles.metricLabel}
                >
                  <Activity size={19} /> Total participation
                </p>
                <span className={styles.metricNote}>2016 - 2024</span>
              </header>
                  ...
                  >
                    <defs>
                      ...
                      >
                        ...
                        <stop offset="58%" stopColor="#c056f6" />
                        <stop offset="100%" stopColor="#ff5fcf" />
                      </linearGradient>
                    </defs>

                    <CartesianGrid
                      horizontal={false}
                      stroke="rgba(250,235,146,0.1)"
                      strokeDasharray="3 6"
                    />
                    ...
                    <Tooltip
                      cursor={{
                        fill: 'rgba(255,95,207,0.08)',
                      }}
                      content={
                        <ChartTooltip suffix="participants" />
                      }
                    />

                    <Bar
                      dataKey="participants"
                      fill="url(#participation-bars)"
                      barSize={18}
                      tabIndex={-1}
                      style={{ outline: 'none' }}
                      shape={(props) => (
                        <ParticipationBar
                          {...props}
                          activeLabel={activeParticipationLabel}
                        />
                      )}
                      isAnimationActive={hasEnteredViewport}
                      animationBegin={350}
